...
class ExportService:
    ...
    def export_filtered_images(self, filters: SearchFilters, destination_dir: str) -> ExportResult:
        ...
        with self.session_factory() as session:
            ...
            for image in images:
                if self._copy_image(image, resolved_destination):
                    copied += 1
                else:
                    skipped += 1
    ...
    def _copy_image(self, image: Image, destination_root: Path) -> bool:
        try:
